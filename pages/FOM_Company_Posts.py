...
st.markdown("<h1 style='text-align: center; color: cyan;'>FOM Real Estate LinkedIn Posts</h1>", unsafe_allow_html=True)
...
mutares_emp_path = 'https://phantombuster.s3.amazonaws.com/UhrenaxfEnY/KgmQq1abSlO1c4WAOKW0PA/FOM_COMPANY_POSTS_5_25.csv'
